            ...
            <Col xs="12" md="4" lg="3">
              <div className={`filter-list ${filteropen ? "filteropen" : ""}`}>
                <div className="filter-header">
                  ...
                  <a href="#" className="filter-clear">Clear All</a>
                  <div className="filter-close"><button className="fc-btn" onClick={() => setFilteropen(false)}><span>Close</span></button></div>
                </div>
                <div className="filter-collapse-outer">
                  <div className="filter-item">
                    <h3 className="filter-item-title" id="fc1">
                      <div className="ft-top"><span>Shop by age</span><i></i></div>
                  ...
                  <div className="filter-item">
                    <h3 className="filter-item-title expanded" id="fc2">
                      <div className="ft-top"><span>Price</span><i></i></div>
                    </h3>
                  ...
                  <div className="filter-item">
                    <h3 className="filter-item-title expanded" id="fc3">
                      <div className="ft-top"><span>Shop by brand</span><i></i></div>
                  ...
                  <div className="filter-item">
                    <h3 className="filter-item-title expanded" id="fc4">
                      <div className="ft-top"><span>Gender</span><i></i></div>
                      <div className="ft-bottom d-none"></div>
                    </h3>
                  ...
                  <div className="filter-item">
                    <h3 className="filter-item-title expanded" id="fc5">
                      <div className="ft-top"><span>Recommended for</span><i></i></div>
                      <div className="ft-bottom d-none"></div>
                    </h3>
                  ...
                  <div className="filter-item">
                    <h3 className="filter-item-title expanded" id="fc2">
                      <div className="ft-top"><span>Show all</span><i></i></div>
                    </h3>
                    <UncontrolledCollapse toggler="#fc2" defaultOpen={true}>
            ...
            <Col xs="12" md="8" lg="9">
              <div className="list-data-outer">
                ...
                <div className="data-sort">
                  <div className="filter-options-mobile">
                    <Button className="filter-option-btn" onClick={() => setFilteropen(true)}>Edit filters</Button>
                  </div>
                  <div className="dropdown-custom">
                    <Dropdown isOpen={dropdownOpen} toggle={toggle}>
                      ...
                      <DropdownMenu right>
                        ...
                        <DropdownItem>Product name: A - Z</DropdownItem>
                        <DropdownItem>Product name: Z - A</DropdownItem>
                        <DropdownItem>Top sellers</DropdownItem>
                      </DropdownMenu>
                    </Dropdown>
                  </div>
                </div>
              ...
              <div className="list-items-outer">
                ...
                <div className="pagination-outer">
                  ...
                  <div className="pagination-result">Page <span>1</span> of <span>31</span></div>
                  <Button color="info" className="page-right"></Button>
                </div>
              </div>
            </Col>
          </Row>
        ...
        <Container>
          <div className="bottom-contents">
            <div className="content-item">
              <h6>Baby Dolls</h6>
              <p>At Toys ‘R’ Us, we stock a wide array of cute and cuddly baby dolls for your kids to play with. He or she can pretend to be a new parent by caring for a dolly, from changing its nappy to feeding it and giving it a refreshing bath. In the mood for a short walk? Get the doll’s travel bag and fill it with all the essentials such as spare clothes, feeding bottles, stack of diapers and more, and you and your baby are ready to head on out.</p>
            </div>
            <UncontrolledCollapse toggler="#bContent" className="bottom-content-toggle">
              <Card>
                <CardBody>
                  <h6>Celebrity Dollies</h6>
                  <p>Does your kid want to roam the realm with Anna, have a picnic party on the beach with Barbie or maybe just a tea party with Masha? Now, you can let her or him do it all with our range of dollies that are miniatures of popular characters or personalities. Whether your child is into Disney princesses or fashion dolls, she’ll have hours of playtime with our collection.</p>
                  <h6>Doll Houses</h6>
                  <p>Even dolls need a home and what better way to give them their own space than with our collection of doll houses and castles? The best part is, your child can also decorate these little dwellings with our selection of miniature furniture and dollhouse accessories.</p>
                  <h6>Fashionistas</h6>
                  <p>Future fashion icons will be delighted with our collection of fashion dolls. Most come with their own set of doll clothes and matching shoes and bags, while others also come with beauty accessories so that your child can style them as he or she pleases.</p>
                  <p>Check out our range available online and in our stores in Dubai, Abu Dhabi, Al Ain and Sharjah. Buy online and have your order delivered to any point in the QAT.</p>
                </CardBody>
              </Card>
            </UncontrolledCollapse>
