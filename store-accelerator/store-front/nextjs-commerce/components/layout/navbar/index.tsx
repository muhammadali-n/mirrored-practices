  ...
  useEffect(() => {
    ...
    return (
        <nav className="navbar navbar-expand-lg navbar-dark bg-dark">
            {headerData.map((page: any, index: number) => (
                    ...
                    <Link href="/" className="navbar-brand">
                        <div className="d-flex align-items-center">
                            <div className="col-sm-12 d-flex justify-content-center">
                                ...
                                <img src={urlFor(page.storeLogo.logo.asset._ref).url()} alt={page.storeLogo.alt} width={50} height={40} />
                            </div>
                    ...
                    <div className="collapse navbar-collapse justify-content-between" id={`navbarSupportedContent-${index}`}>
                        ...
                        <form className="d-flex justify-content-center position-relative navbar-form">
                            <input
                                type="text"
                                name="search"
                                placeholder={page.searchBar.placeholderText}
                                autoComplete="off"
                                className="form-control bg-dark text-white search-input"
                                style={{ width: '400px'
                        ...
                        <div className="d-flex align-items-center">
                            ...
                            <Link href={`/cart/cart`} className="nav-link text-white">
                                ...
                                <img src={urlFor(page.cartIcon.icon.asset._ref).url()} alt={page.cartIcon.alt} width={30} height={30} style={{ position: 'absolute', right: '10px', top: '50%', transform: 'translateY(-50%)' }} />
                            </Link>
                        </div>
                    </div>
                </div>
