...
export default function Navbar() {
  ...
  // const handleOnclick = async (selectedVariantId: any) => {
  //   const search = await performCommonIntegration(getSearchSuggestions, searchQuery)
  ...
  //   const search = await performCommonIntegration(getSearchSuggestions, value)
  ...
  //                 <li key={index}>
  //                   {suggestion}
  //                   {/* <button onClick={() => handleItemClick(suggestion)}>Add to Cart</button> */}
  //                 </li>
  //               ))}
  //             </ul>
  //           ) : (
